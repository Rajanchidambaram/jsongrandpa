...
export default function ValidatorClient() {
    ...
    const [status, setStatus] = useState({ type: 'idle', message: 'Ready to validate' });
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <h1 className="text-3xl font-bold text-brand-charcoal">JSON Validator</h1>
                <div className="flex flex-wrap gap-2">
                    <button onClick={validate} className="bg-brand-orange text-white px-4 py-2 rounded font-medium hover:bg-orange-600 transition-colors shadow-sm" title="Ctrl/Cmd + Enter">
                        Validate
                    </button>
                    <button onClick={formatJSON} className="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded font-medium hover:bg-gray-50 transition-colors shadow-sm" title="Ctrl/Cmd + Shift + F">
                        Format
                    </button>
            ...
            <div className="mt-12 grid md:grid-cols-2 gap-8">
                <div>
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-gray-600">
                        ...
                        <li>Use <strong>Format</strong> to pretty-print or <strong>Minify</strong> to compress.</li>
                    </ol>
                </div>
                <div>
